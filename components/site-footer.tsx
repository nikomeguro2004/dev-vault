...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-white/15 bg-zinc-950/90 reveal-up">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-6 text-sm text-zinc-400 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="font-medium text-zinc-200 transition-[color,transform] duration-200 ease-out hover:-translate-y-px hover:text-white"
          >
